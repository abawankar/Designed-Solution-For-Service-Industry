    ...
    public class AccountTypeController : Controller
    {
        ...
        public JsonResult List(string name = null, int jtStartIndex = 0, int jtPageSize = 0, string jtSorting = null)
        {
            try
            {
                ...
                List<AccountTypeModel> model = new List<AccountTypeModel>();
                ...
                List<AccountTypeModel> Model1 = model.Skip(jtStartIndex).Take(jtPageSize).ToList();
        ...
        [HttpPost]
        public JsonResult Update(AccountTypeModel model)
        {
            try
            {
                if (!ModelState.IsValid)
        ...
        [HttpPost]
        public JsonResult GetAccountTypeOptions()
        {
            try
            {
                AccountTypeRepository dal = new AccountTypeRepository();
